...
gulp.task('images', () => {
  return gulp.src([ src_assets_folder + 'images/**/*.+(png|jpg|jpeg|gif|svg|ico|webmanifest)' ], { since: gulp.lastRun('images') })
    .pipe(plumber())
    .pipe(imagemin())
...
gulp.task('build', gulp.series('clear', 'html', 'pug', 'sass', 'less', 'stylus', 'js', 'images', 'fonts', 'vendor'));
