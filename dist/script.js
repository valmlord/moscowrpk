...
/* harmony import */ var _modules_brandsSlider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/brandsSlider */ "./src/js/modules/brandsSlider.js");
/* harmony import */ var _modules_brandsSlider__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_brandsSlider__WEBPACK_IMPORTED_MODULE_3__);
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".portfolio__tabs", ".portfolio__tab", ".portfolio__content", "portfolio__tab_active");
  homeAnim();
  moneyAnim();
  deliveryAnim();
  orderAnim();
...
accordionItems.forEach(function (itemAccordion) {
  // accordion content
  var accordionTitle = itemAccordion.querySelector(".faq__title");
  var accordionContent = itemAccordion.querySelector(".content");
  var accordionArrow = itemAccordion.querySelector(".arrow"); // on click title
  ...
  accordionTitle.addEventListener("click", function (event) {
    ...
    if (!itemAccordion.classList.contains("-active")) {
      ...
      accordionItemsActive.forEach(function (itemAccordionActive) {
        var accordionContent = itemAccordionActive.querySelector(".content");
        var accordionArrow = itemAccordionActive.querySelector(".arrow"); // remove active class accordion item
...
var moneyAnim = lottie.loadAnimation({
  container: document.getElementById("money-icon"),
  // the dom element that will contain the animation
  renderer: "svg",
  loop: true,
  autoplay: true,
...
var deliveryAnim = lottie.loadAnimation({
  container: document.getElementById("delivery-icon"),
  // the dom element that will contain the animation
  renderer: "svg",
  loop: true,
  autoplay: true,
...
var orderAnim = lottie.loadAnimation({
  container: document.getElementById("order-icon"),
  // the dom element that will contain the animation
  renderer: "svg",
  loop: true,
  autoplay: true,
...
var guaranteeAnim = lottie.loadAnimation({
  container: document.getElementById("guarantee-icon"),
  // the dom element that will contain the animation
  renderer: "svg",
  loop: true,
  autoplay: true,
...
var paymentAnim = lottie.loadAnimation({
  container: document.getElementById("payment-icon"),
  // the dom element that will contain the animation
  renderer: "svg",
  loop: true,
  autoplay: true,
...
/***/ "./src/js/modules/brandsSlider.js":
/*!****************************************!*\
  !*** ./src/js/modules/brandsSlider.js ***!
  \****************************************/
/*! no static exports found */
...
if (slideshow != null) {
  ...
  slideHandlers.prevSlide("#prev-slide"); // Dynamic slideshow height
  ...
  }); // Detect swipe events for touch devices, credit to Kirupa @
  ...
  slideshow.addEventListener("touchmove", moveTouch, false); // optional autoplay function
